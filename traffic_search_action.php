<html>
	...
	<body>
		...
		<h2 style="font-style:italic; font-size:30px;padding-left:30px;">Traffic Record</h2>
...
<?php
		...
		$sql = "SELECT * FROM traffic_record WHERE trafficrecord_id='$trafficrecordid'";
		...
		if ($result->num_rows > 0) {
			...
			while($row = $result->fetch_assoc()) {
				...
				echo "<tr><td>Traffic Record Id : </td><td>".$row['trafficrecord_id']."</td></tr>";
				...
				echo "<tr><td>Vehicle No : </td><td>".$row['vehicle_number']."</td></tr>";
				echo "<tr><td>Fine Amount : </td><td>".$row['fine_amount']."</td></tr>";
			...
			echo "<div id='card'><p>Record not Exist</p><form action='traffic_search.php' method='get'><button type='submit' id='done'>Done</button></form></div>";
