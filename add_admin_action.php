...
<?php
		...
		$policedesig = filter_input(INPUT_GET,'policedesig');
		...
		$sql = "INSERT INTO admin_database (police_id, police_name, police_password, police_designation, police_address, police_phone, police_email) 
		VALUES ('$policeid', '$policename', '$policepass','$policedesig','$policeaddress','$policenumber','$policeemail')";
