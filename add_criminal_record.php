		...
		<div class="container">
			<form action="add_criminal_record_action.php" method = "get">
				...
				<div class="row">
					...
					<div class="col-75">
						<input type="text" pattern=".{1,}" required name="crimerecordid" placeholder="Enter Record Id...">
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-75">
						<input type="text" pattern=".{1,}" required name="crimialname" placeholder="Criminal Name...">
					</div>
				</div>
				...
				<div class="row">
					<div class="col-25">
						<label for="lname">Witness Name</label>
					</div>
					<div class="col-75">
						<input type="text" pattern=".{1,}" required name="witnessname" placeholder="Witness Name...">
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-75">
						<input type="text" pattern=".{1,}" required name="crimeaddress" placeholder="crime address...">
					</div>
				</div>
