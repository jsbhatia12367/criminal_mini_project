<html>
	...
	<body>
		...
		<h2 style="font-style:italic; font-size:30px;padding-left:30px;">Search Crime Record</h2>
		...
		<div class="container">
			<form action="criminal_search_action.php" method = "get">
				<div class="row">
					...
					<div class="col-75">
						<input type="text" pattern=".{1,}" required  name="crimerecordid" placeholder="Record Id..">
					</div>
				</div>
